...
server <- function(input, output, session) {
  # volumes <- c("baller" = R.home())
  
  volumes <- c("baller" = "C:/Users")
  # shinyDirChoose(input, "directory", roots = volumes,
  # session = session)
  # shinyDirChoose(input, 'folder', roots=c(wd='C:/Users'), session = session)
  # shinyDirChoose(input, 'directory', roots=volumes, session = session)
  
  # session = session, restrictions = system.file(package = "base"))
  
  # volumes <- c("baller" = "home")
  # shinyDirChoose(input, "directory", roots = volumes, session = session, restrictions = system.file(package = "base"))
  # shinyDirChoose(input, "directory", roots = volumes, session = session)
  
  # shinyDirChoose(input, "directory", roots=c(wd='C:/Users'), session = session)
